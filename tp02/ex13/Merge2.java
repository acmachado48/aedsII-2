...
public class Merge2{
     ...
     private static void swap(Pokemon[] vetor, int i, int j) {
    ...
    for (int j = i + 1; j < tamVet; j++) {
        // Comparar os tipos dos Pokémon (comparando o primeiro tipo da lista)
        int typeComparison = vetor[j].getTypes().get(0).compareTo(vetor[menor].getTypes().get(0));
        
        // Se os tipos forem iguais, comparar os nomes
        if (typeComparison == 0) {
