...
public class pesquisaSeq{
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            String[] pesquisa = new String[500];
            int tamPesq = 0;
            String nome;
            
            //ler nomes a serem pesquisados
            while (!(nome = sc.nextLine()).equals("FIM")) {
                pesquisa[tamPesq++] = nome;
                
            }
            
            
            //pesquisar sequencialmente para verificar se o nome esta no vetor
            for(int j = 0; j < tamPesq; j++){
                boolean encontrado = false;
                for(int i = 0; i < tamVet; i++){
                    if(vetor[i].getName().equals(pesquisa[j])){
